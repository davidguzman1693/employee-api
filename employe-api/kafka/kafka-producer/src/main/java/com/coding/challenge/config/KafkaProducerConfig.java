...
public class KafkaProducerConfig<K extends Serializable, V extends SpecificRecord>{
  ...
  /**
   * Wrapper class and thread-safe template for executing high level producer operations.
   *
  ...
  private Map<String, Object> producerConfig() {
    ...
    props.put(kafkaConfigData.getSchemaRegistryUrlKey(), kafkaConfigData.getSchemaRegistryUrlAlt());
